...
export default function Dashboard() {
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          >
            ...
            <div className='flex bg-red-500 justify-between w-100%'>
              <h1>Ayomide</h1>
              <h1>Ayomide</h1>
          </div>
        </Toolbar>
  ...
  <ListItem disablePadding sx={{ display: 'block' }}>
    ...
    >
      ...
      <ListItemText primary="Starred" sx={[open ? { opacity: 1 } : { opacity: 0 }]} />
    </ListItemButton>
  </ListItem>
  ...
  <ListItem disablePadding sx={{ display: 'block' }}>
    ...
    >
      ...
      <ListItemText primary="Send Email" sx={[open ? { opacity: 1 } : { opacity: 0 }]} />
    </ListItemButton>
  </ListItem>
  ...
  <ListItem disablePadding sx={{ display: 'block' }}>
    ...
    >
      ...
      <ListItemText primary="Drafts" sx={[open ? { opacity: 1 } : { opacity: 0 }]} />
    </ListItemButton>
  </ListItem>
</List>
        <Divider />
